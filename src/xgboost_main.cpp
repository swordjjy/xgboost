    ...
    inline void InitData(void) {
      ...
      if (task == "pred") {
        ...
        for (size_t i = 0; i < eval_data_names.size(); ++i) {
          //if (strncmp(eval_data_names[i].c_str(), "train", 5) == 0) ////////////////////////////////////////////////////////////////
          //  continue; ////////////////////////////////////////////////////////////////
        ...
        if (eval_train != 0) {
          ...
          //devalall.push_back(data); ////////////////////////////////////////////////////////////////
          //eval_data_names.push_back("train:" + train_path); ////////////////////////////////////////////////////////////////
          //eval_data_paths.push_back(train_path); ////////////////////////////////////////////////////////////////

          devalall.insert(devalall.begin() + 1, data);
          eval_data_names.insert(eval_data_names.begin() + 1, "train:" + train_path); ////////////////////////////////////////////////////////////////
          eval_data_paths.insert(eval_data_paths.begin() + 1, train_path); ////////////////////////////////////////////////////////////////
        }
      }
    }
